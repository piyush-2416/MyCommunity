...
import "./App.css";import "./index.css"
 function App() {
  ...
  class="inline-block bg-gray-800 hover:bg-gray-900 px-4 py-3 rounded-md font-semibold text-white text-sm text-center uppercase transition duration-200 ease-in-out cursor-pointer">
  Button
</button>
      </div>
